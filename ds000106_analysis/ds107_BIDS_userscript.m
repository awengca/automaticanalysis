...
aap.acq_details.root = '/Users/andrewweng/Data/ds001430';
aap.directory_conventions.analysisid = 'RESULTS';

% just point rawdatadir at the top level BIDS dir; processBIDS does the rest

aap.directory_conventions.rawdatadir = '/Users/andrewweng/Data/ds001430';
...
% 
 aap = aas_addcontrast(aap, 'aamod_firstlevel_contrasts_*', '*', 'sameforallsessions', [1,0,0,0] , 'auditory oddball stimulus presentation','T');
%  
 aap = aas_addcontrast(aap, 'aamod_firstlevel_contrasts_*', '*', 'sameforallsessions', [0,1,0,0] , 'behavioral response time following auditory oddball stimulus onset','T');
% 
