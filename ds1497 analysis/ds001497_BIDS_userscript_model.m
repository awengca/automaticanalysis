...
aap = aarecipe('aap_parameters_ANDREW.xml','ds001497_BIDS_tasklist_model.xml');
% ------------------------------------------------------------------------------------------------------------------------------
% FSL hack
% ------------------------------------------------------------------------------------------------------------------------------
...
% second level goes here ----------


% add input stream from first level

% aap = aas_addsubject(aap, '/Users/andrewweng/Data/ds001497/RESULTS/aamod_firstlevel_model_00001');
